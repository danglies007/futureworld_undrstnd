...
from scan_sources.models import Market_Force, Market_Force_Plan
    ...
    def research_market_forces(self):
        ...
        for i, market_force in enumerate(research_plan.market_forces, 1):
            ...
            try:
                ...
                # Create a ResearchCrewInput instance with the market force and user variables
                crew_input = ResearchCrewInput(
                    market_force=market_force,
                    user_variables=self.user_input_variables
                )
                # Use the new approach to kickoff the research crew
                result = ResearchCrew().crew().kickoff(crew_input.model_dump()).pydantic
