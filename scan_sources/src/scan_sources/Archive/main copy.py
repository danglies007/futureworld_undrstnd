...
class ScanFlow(Flow):
    ...
    def wait_for_approval(self):
        ...
        This method checks if we're running in a terminal environment and asks for 
        input directly. Otherwise, it will wait for the web interface to call the 
        appropriate methods.
        """
        ...
        if sys.stdin.isatty():
            ...
            if approval == 'y':
                ...
                self.emit("research_plan_approved")
                return None
            else:
