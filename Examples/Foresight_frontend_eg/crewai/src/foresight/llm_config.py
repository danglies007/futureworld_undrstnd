...
# Configure LiteLLM rate limits globally if needed
# Example for Claude:
# litellm.rate_limit_config = {
#     "claude-3-7-sonnet-latest": {
#         "rpm": 20,  # 20 requests per minute
#         "input_tpm": 30000,  # 30,000 input tokens per minute
#         "output_tpm": 8000  # 8,000 output tokens per minute
#     }
# }
...
llm_gpt4o = LLM(model="chatgpt-4o-latest") # Fast intelligent $2.50/$10
